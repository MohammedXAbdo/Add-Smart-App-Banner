...
* Plugin URI: https://github.com/MohammedXAbdo/Add-Smart-App-Banner
* Description: Add a Smart App Banner to your website to increase app installs
* Version: 1.0
* Author: Mohammed Abdo
* Author URI: https://facebook.com/Mohammed.abdom2
* License: GNU v3.0
*/



function asab_setup_theme_plugin_menus() {
     add_options_page(
        'Smart App Banners',
         'Smart App Banners',
          'manage_options', 
...
function asab_script(){
	wp_enqueue_script( 'asab_js', plugins_url( '/smart-app-banner.js', __FILE__ ),false);
